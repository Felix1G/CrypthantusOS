...
binutils: $(TOOLCHAIN_PREFIX)/bin/i686-elf-ld
...
gcc: $(TOOLCHAIN_PREFIX)/bin/i686-elf-gcc
...
$(TOOLCHAIN_PREFIX)/bin/i686-elf-gcc: $(TOOLCHAIN_PREFIX)/bin/i686-elf-ld $(GCC_SRC).tar.xz
	...
	@mkdir $(GCC_BUILD)
	@cd $(GCC_BUILD) && CFLAGS= ASMFLAGS= CC= CXX= LD= ASM= LINKFLAGS= LIBS= ../gcc-$(GCCVERSION)/configure \
		--prefix="$(TOOLCHAIN_PREFIX)" \
		--target=$(TARGET) \
		--disable-nls \
...
.PHONY: toolchain binutils gcc clean-toolchain clean-toolchain-all